        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParentChildRelations_Persons_ChildId",
                        column: x => x.ChildId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ParentChildRelations_Persons_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerRelations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartnerRelations_Persons_Person1Id",
                        column: x => x.Person1Id,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PartnerRelations_Persons_Person2Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParentChildRelations_ChildId",
                table: "ParentChildRelations",
                column: "ChildId");

            migrationBuilder.CreateIndex(
                name: "IX_ParentChildRelations_ParentId",
                table: "ParentChildRelations",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_PartnerRelations_Person1Id",
                table: "PartnerRelations",
                column: "Person1Id");

            migrationBuilder.CreateIndex(
                name: "IX_PartnerRelations_Person2Id",
                table: "PartnerRelations",
                column: "Person2Id");
